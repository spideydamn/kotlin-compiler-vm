...
Добавляет функцию в текущую область. Возвращает `false`, если функция уже определена в этой области.
...
Ищет функцию, начиная с текущей области и поднимаясь по цепочке родительских областей.
